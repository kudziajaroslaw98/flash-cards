  ...
  return (
    ...
    >
      ...
      <div className='flex w-full min-w-44 flex-col items-start gap-2 p-2 py-4 text-sm md:w-auto md:flex-row md:items-center md:border-r md:border-r-slate-400/20 md:py-2'>
        <div
          className={`w-full rounded-md border-transparent bg-gray-100 p-2 text-base font-semibold outline-none ring-blue-400 transition-all focus:ring-1 md:text-sm dark:bg-slate-600`}
        >
          {props.flashCard.word}
        </div>

        <div
          className={`h-20 w-full resize-none rounded-md border-transparent bg-gray-100 p-2 outline-none ring-blue-400 transition-all focus:ring-1 md:hidden dark:bg-slate-600`}
        >
      ...
      <div className='line-clamp-2 hidden w-full items-center p-2 px-4 text-sm md:flex'>
        <div
          className={`hidden w-full resize-none rounded-md border-transparent bg-gray-100 p-2 outline-none ring-blue-400 transition-all focus:ring-1 md:flex md:h-10 dark:bg-slate-600`}
        >
          {props.flashCard.definition}
        </div>
      </div>
