...
export default function CardComponent(
  ...
  return (
    <div
      ...
      className={`group relative -z-0 flex cursor-pointer rounded-md border border-gray-200 bg-gray-50 p-8 transition-all active:scale-95 dark:border-slate-800 dark:bg-slate-900 ${
        props.class ?? ''
      }`}
    >
      <motion.div
